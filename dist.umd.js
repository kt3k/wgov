...
var createByText = function (text) {
...
var createFromQueryString = function () { return createByText(parse(location.search).sgf); };
var isValidQueryString = function () {
    var qs = parse(location.search);
    return !(!qs.sgf) && qs.sgf.length > 0;
};

exports.createFromQueryString = createFromQueryString;
